...
####Import data 
lake <- read_excel("data/CT_Hgiso_mm.xlsx")
## read endmembers
...
p1
ggsave(
  filename = "guanothroughtime_CT.pdf",
  plot = p1,
  width = 8,
  height = 5
)
...
p
ggsave(
  filename = "Hg_source_pre_post1850_CT.pdf",
  plot = p,
  width = 8,
  height = 5
)
